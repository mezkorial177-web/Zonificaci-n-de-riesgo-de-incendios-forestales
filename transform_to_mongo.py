...
def transformar_fila(fila):
    ...
    doc = {
        ...
        # Formato extendido de MongoDB: mongoimport lo convierte a BSON
        # Date real. Un string ISO plano (sin "$date") se hubiera quedado
        # como string -- ya lo confirmamos con typeof en el Lab.
        "fecha_hora": {"$date": fecha_hora.strftime("%Y-%m-%dT%H:%M:%S.000Z")},
